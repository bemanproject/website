...
const FeatureList: FeatureItem[] = [
  {
    ...
    description: (
      <>
        {" "}
        The Beman Project’s mission is to support the efficient design and
        adoption of the highest quality C++ Standard libraries through
        ...
        proposed for ISO standardization making a simple usage experience for
  ...
  },
  {
    ...
    description: (
      <>
        The Beman Project strives to be a distributor of a single-download
        library collection for C++ libraries proposed for standardization. Our
        goals are to provide stable distributions that match with the latest
