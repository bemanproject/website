...
def parse_args():
    ...
    parser.add_argument("beman_repo_path", help="path to beman/ repo", type=str)
...
def main():
    ...
    sync_beman_docs(beman_repo_path, website_repo_path, 'docs/BEMAN_STANDARD.md', 2)
    sync_beman_docs(beman_repo_path, website_repo_path, 'docs/CODE_OF_CONDUCT.md', 3)
    sync_beman_docs(beman_repo_path, website_repo_path, 'docs/FAQ.md', 4)
    sync_beman_docs(beman_repo_path, website_repo_path, 'docs/GOVERNANCE.md', 5)
    sync_beman_docs(beman_repo_path, website_repo_path, 'docs/MISSION.md', 7)
